...
namespace EKTemplate
{
    ...
    public class InputManager : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
    {
        ...
        //     if (useCursor) ray = CameraManager.instance.cam.ScreenPointToRay(cursor.position);
        //     else ray = CameraManager.instance.cam.ScreenPointToRay(eventData.position + rayOffset);
